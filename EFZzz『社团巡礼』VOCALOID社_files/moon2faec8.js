...
var l,u,d,w,f,m,p,_=/MicroMessenger/i.test(navigator.userAgent),h=window.define,g=0,v=2,y=4,O=9,j=10;
if(window.__initCatch=function(e){
l=e.idkey,u=e.startKey||0,d=e.limit,w=e.badjsId,f=e.reportOpt||"",m=e.extInfo||"";
},window.__moon_report=function(o){
if(/mp\.weixin\.qq\.com/.test(location.href)&&!(Math.random()>.5)&&_&&top==window&&(t(o)&&(o=[o]),
e(o)&&""!=l)){
var r="",a=[],s=[],c=[],f=[];
"number"!=typeof d&&(d=1/0);
for(var p=0;p<o.length;p++){
var h=o[p]||{};
if(!(h.offset>d||"number"!=typeof h.offset||h.offset==y&&m&&m.network_rate&&Math.random()>=m.network_rate)){
var g=1/0==d?u:u+h.offset;
a[p]="[moon]"+l+"_"+g+";"+h.log+";"+n(h.e||{})||"",s[p]=g,c[p]=1;
}
}
for(var v=0;v<s.length;v++)f[v]=l+"_"+s[v]+"_"+c[v],r=r+"&log"+v+"="+a[v];
if(f.length>0&&(i("POST",location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?","idkey="+f.join(";")+"&lc="+a.length+r),
w)){
var O=new Image,j="https://badjs.weixinbridge.com/badjs?id="+w+"&level=4&from="+encodeURIComponent(location.host)+"&msg="+encodeURIComponent(r);
...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=2,l={
prefix:"__MOON__",
loaded:[],
unload:[],
hit_num:0,
...
c!=l.version&&(l.clear(),i.setItem(s,l.version));
}
if(-1!=location.search.indexOf("no_moon1=1")&&l.clear(),i){
var u=1*i.getItem(l.prefix+"clean_time"),d=+new Date;
if(d-u>=1296e6){
l.clear();
try{
!!i&&i.setItem(l.prefix+"clean_time",+new Date);
}catch(w){}
}
}
r(moon_map,function(r,s){
if(n=l.prefix+s,a=!!r&&r.replace(/^http(s)?:\/\/res.wx.qq.com/,""),t=!!i&&i.getItem(n),
version=!!i&&(i.getItem(n+"_ver")||"").replace(/^http(s)?:\/\/res.wx.qq.com/,""),
l.mod_num++,t&&a==version){
...
try{
var u="";
e.eval.call(e,'define("'+s+'",[],'+t+")"+u),l.hit_num++;
}catch(c){
l.unload.push(a.replace(/^http(s)?:\/\/res.wx.qq.com/,""));
}
}else l.unload.push(a.replace(/^http(s)?:\/\/res.wx.qq.com/,""));
}),l.load(l.genUrl());
},
genUrl:function(){
var e=l.unload;
...
for(var c=0,u=e.length;u>c;++c)/^\/(.*?)\//.test(e[c]),RegExp.$1&&(o=RegExp.$1,n=i[o],
n?(t=n+","+e[c],t.length>1e3||a?(r.push(n+"?v="+l.version),n=location.protocol+s+e[c],
i[o]=n):(n=t,i[o]=n)):(n=location.protocol+s+e[c],i[o]=n));
for(var d in i)i.hasOwnProperty(d)&&r.push(i[d]);
return r;
},
load:function(e){
if(!e||e.length<=0)return seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),void(console.debug&&console.debug("[moon] load js complete, all in cache, cost time : 0ms, total count : "+l.mod_num+", hit num: "+l.hit_num));
seajs.combo_status=seajs.COMBO_LOADING;
var t=0,o=+new Date;
r(e,function(n){
l.request(n,c,function(){
if(t++,t==e.length){
var n=+new Date-o;
seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),console.debug&&console.debug("[moon] load js complete, url num : "+e.length+", total mod count : "+l.mod_num+", hit num: "+l.hit_num+", use time : "+n+"ms");
}
});
});
},
...
if(t(r,"status","error"),t(r,"end",+new Date),o>=0)l.request(e,o,n);else if(window.__moon_report){
var a=new Error(i);
...
clear:function(){
i&&(r(i,function(e,t){
~t.indexOf(l.prefix)&&i.removeItem(t);
